...
var ArtistComponent = (function () {
    // safeUrl:any	
    function ArtistComponent(_spotify, _router, sanitizer) {
    ...
    ArtistComponent.prototype.ngOnInit = function () {
        ...
        this._router.params
            ...
            _this._spotify.searchArtist(id)
                .subscribe(function (artist) {
                _this.artist = artist;
            });
            _this._spotify.getAlbum(id)
                .subscribe(function (albums) {
                _this.albums = albums.items;
                console.log(albums);
                _this.imagesUrl = _this.albums[0].images[0].url;
                _this.safeUrl = _this.sanitizer.bypassSecurityTrustResourceUrl(_this.imagesUrl);
            });
        });
    };
